...
target_include_directories(onnxruntime_common PRIVATE ${ONNXRUNTIME_ROOT} ${date_INCLUDE_DIR} ${NSYNC_INCLUDE_DIR})
# logging uses date. threadpool uses eigen
add_dependencies(onnxruntime_common date eigen gsl nsync)
